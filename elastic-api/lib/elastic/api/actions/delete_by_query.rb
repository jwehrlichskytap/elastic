module Elastic
  module API
    module Actions
      ...
      #
      # Provide the query either as a "query string" query in the `:q` argument, or using the Elastic's
      # [Query DSL](http://www.elastic.org/guide/reference/query-dsl/) in the `:body` argument.
      #
      ...
      #
      # @see http://www.elastic.org/guide/reference/api/delete-by-query/
      #
