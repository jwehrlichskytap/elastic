module Elastic
  module API
    module Actions
      ...
      #
      # @see http://www.elastic.org/guide/en/elastic/guide/current/scan-scroll.html#scan-scroll
      # @see http://www.elastic.org/guide/reference/api/search/scroll/
      # @see http://www.elastic.org/guide/reference/api/search/search-type/
      #
