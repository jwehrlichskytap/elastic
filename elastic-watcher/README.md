...
Install the package from [Rubygems](https://rubygems.org):
    ...
    gem install elastic-watcher

To use an unreleased version, either add it to your `Gemfile` for [Bundler](http://gembundler.com):

    gem 'elastic-watcher', git: 'git://github.com/elastic/elastic-ruby.git'

or install it from a source code checkout:

    git clone https://github.com/elastic/elastic-ruby.git
    cd elastic-ruby/elastic-watcher
    bundle install
    rake install

## Usage

The documentation for the Ruby API methods is available at <http://www.rubydoc.info/gems/elastic-watcher>.
...
client = Elastic::Client.new url: 'http://localhost:9200', log: true
