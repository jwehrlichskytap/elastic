...
The `skytap_elastic-api` library provides a Ruby implementation of
...
Install the package from [Rubygems](https://rubygems.org):
    ...
    gem install skytap_elastic-api

To use an unreleased version, either add it to your `Gemfile` for [Bundler](http://gembundler.com):

    gem 'skytap_elastic-api', git: 'git://github.com/elastic/skytap_elastic-ruby.git'

or install it from a source code checkout:

    git clone https://github.com/elastic/skytap_elastic-ruby.git
    cd skytap_elastic-ruby/skytap_elastic-api
    bundle install
    rake install
...
**When you use the client from the [`skytap_elastic-ruby`](https://github.com/elastic/skytap_elastic-ruby/) package,
...
and available online at <http://rubydoc.info/gems/skytap_elastic-api>.
...
```ruby
SkytapElastic::API.settings[:serializer] = JrJackson::Json
SkytapElastic::API.serializer.dump({foo: 'bar'})
# => {"foo":"bar"}
```
