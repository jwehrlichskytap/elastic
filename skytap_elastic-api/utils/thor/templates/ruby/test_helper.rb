...
Dir[ File.expand_path('../../lib/skytap_elastic/api/**/*.rb', __FILE__) ].each do |f|
...
module SkytapElastic
  ...
  module Test
    ...
    class FakeClient
      ...
      SkytapElastic::Test.__full_namespace(SkytapElastic::API).select { |m| m.to_s =~ /Actions$/ }.each do |m|
