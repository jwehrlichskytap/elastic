  ...
  module API
    module Cat
      module Actions
        ...
        # Display a terse version of the {SkytapElastic::API::Cluster::Actions#health} API output
        #
        ...
        #
        # @see http://www.elastic.org/guide/en/elastic/reference/master/cat-health.html
        #
