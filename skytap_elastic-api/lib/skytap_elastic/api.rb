...
require "skytap_elastic/api/namespace/common"
require "skytap_elastic/api/utils"
...
module SkytapElastic
  module API
    ...
    def self.included(base)
      base.send :include,
                SkytapElastic::API::Common,
                SkytapElastic::API::Actions,
                SkytapElastic::API::Cluster,
                SkytapElastic::API::Nodes,
                SkytapElastic::API::Indices,
                SkytapElastic::API::Ingest,
                SkytapElastic::API::Snapshot,
                SkytapElastic::API::Tasks,
                SkytapElastic::API::Cat
    end
