...
class Elastic::Extensions::BackupTest < Test::Unit::TestCase
  context "The Backup gem extension" do
    ...
    should "have a client" do
      assert_instance_of Elastic::Transport::Client, @subject.client
    end
    ...
    should "raise an expection for an unsupported type of backup" do
      ...
      assert_raise ::Backup::Database::Elastic::Error do
        @subject.perform!
      end
    end
