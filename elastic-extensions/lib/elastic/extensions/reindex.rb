...
module Elastic
  module Extensions
    ...
    #
    # @see http://www.rubydoc.info/gems/elastic-api/Elastic/API/Actions#reindex-instance_method
    #
    module Reindex
      ...
      Elastic::API::Actions.__send__ :include, API if defined?(Elastic::API::Actions)
      Elastic::Transport::Client.__send__ :include, API if defined?(Elastic::Transport::Client) && defined?(Elastic::API)
      ...
      #
      #     source_client  = Elastic::Client.new url: 'http://localhost:9200'
      #     target_client  = Elastic::Client.new url: 'http://localhost:9250'
      #
      #     reindex = Elastic::Extensions::Reindex.new \
