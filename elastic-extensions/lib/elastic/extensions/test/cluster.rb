...
module Elastic
  module Extensions
    module Test
      ...
      #
      #      system 'wget https://artifacts.elastic.co/downloads/elastic/elastic-5.1.1.tar.gz'
      #      system 'tar -xvf elastic-5.1.1.tar.gz'
      #
      #      require 'elastic/extensions/test/cluster'
      #      Elastic::Extensions::Test::Cluster.start command: 'elastic-5.1.1/bin/elastic'
      #
      ...
      module Cluster
        ...
        class Cluster
          ...
          def initialize(arguments={})
            ...
            @arguments[:command]           ||= ENV.fetch('TEST_CLUSTER_COMMAND',   'elastic')
          ...
          #      Elastic::Extensions::Test::Cluster::Cluster.new.start
          #
          # @example Start a cluster with a custom configuration
          #      Elastic::Extensions::Test::Cluster::Cluster.new(
          ...
          #      Elastic::Extensions::Test::Cluster::Cluster.new.stop
          #
          # @example Stop the cluster reachable on specific port
          #      Elastic::Extensions::Test::Cluster::Cluster.new(port: 9350).stop
          #
          # @return Boolean,Array
          # @see Cluster#start
          #
          ...
          def __default_cluster_name
            "elastic-test-#{Socket.gethostname.downcase}"
          end
          ...
          # if not available, it parses the version number from the `lib/elastic-X.Y.Z.jar` file,
