  ...
  context "Elastic client" do
    ...
    context "when reloading connections" do
      should "keep existing connections" do
        ...
        client = SkytapElastic::Transport::Client.new host: "localhost:#{@port}", adapter: :patron, logger: @logger
    ...
    context "with Faraday adapters" do
      should "set the adapter with a block" do
        ...
        client = SkytapElastic::Transport::Client.new url: "localhost:#{@port}" do |f|
      ...
      should "automatically use the Patron client when loaded" do
        ...
        require 'patron'
        client = SkytapElastic::Transport::Client.new host: "localhost:#{@port}"
