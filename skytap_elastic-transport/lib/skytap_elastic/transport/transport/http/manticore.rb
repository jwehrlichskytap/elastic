  ...
  module Transport
    module Transport
      module HTTP
        ...
        #
        #     client = SkytapElastic::Client.new transport_class: SkytapElastic::Transport::Transport::HTTP::Manticore
        #
        ...
        #       transport_class: SkytapElastic::Transport::Transport::HTTP::Manticore,
        #       ssl: {
