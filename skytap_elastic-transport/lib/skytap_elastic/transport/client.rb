  ...
  module Transport
    ...
    class Client
      ...
      DEFAULT_TRACER = lambda do
        require 'logger'
        logger = Logger.new(STDERR)
        logger.progname = 'skytap_elastic.tracer'
      ...
      #
      # @see SkytapElastic::Transport::Transport::Base
      # @see SkytapElastic::Transport::Transport::HTTP::Faraday
      #
      ...
      #                                        {SkytapElastic::Transport::Transport::Connections::Selector::Base}.
      #
      ...
      #
      # TODO: Refactor, so it's available in SkytapElastic::Transport::Base as well
      #
      # @return [Array<Hash>]
      # @raise  [ArgumentError]
      #
