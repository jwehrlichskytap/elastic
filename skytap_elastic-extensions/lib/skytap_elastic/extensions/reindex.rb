...
module SkytapElastic
  module Extensions
    ...
    #
    # @see http://www.rubydoc.info/gems/skytap_elastic-api/Elastic/API/Actions#reindex-instance_method
    #
    module Reindex
      ...
      module API
        ...
        #
        # This method will be mixed into the Elastic client's API, if available.
        #
      ...
      SkytapElastic::API::Actions.__send__ :include, API if defined?(SkytapElastic::API::Actions)
      SkytapElastic::Transport::Client.__send__ :include, API if defined?(SkytapElastic::Transport::Client) && defined?(SkytapElastic::API)
      ...
      #
      #     source_client  = SkytapElastic::Client.new url: 'http://localhost:9200'
      #     target_client  = SkytapElastic::Client.new url: 'http://localhost:9250'
      #
      #     reindex = SkytapElastic::Extensions::Reindex.new \
      ...
      #
      # Note, that there is a native "Reindex" API in Elastic 2.3.x and higer versions,
