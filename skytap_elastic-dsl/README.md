...
**NOTE:** In order to run the example, you have to allow restoring from the `data.elastic.org` repository by adding the following configuration line to your `elastic.yml`:
