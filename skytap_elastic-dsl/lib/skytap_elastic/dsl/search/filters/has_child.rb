  ...
  module DSL
    module Search
      module Filters
        ...
        #     end
        #
        # @see http://elastic.org/guide/en/elastic/reference/current/query-dsl-has-child-filter.html
        #
        class HasChild
          ...
          def query(*args, &block)
            @query = block ? SkytapElastic::DSL::Search::Query.new(*args, &block) : args.first
            self
          end
